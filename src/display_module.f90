...
contains
    ...
    subroutine draw_interactive_tree(tree_root, items, n_items, selected, &
        ...
        print '(A)', 'Keys: j/k/↑/↓:nav | ←/→:nav tree | space:toggle | a:stage | u:unstage | S:stage-all | U:unstage-all | x:discard | z:stash | Z:unstash | b:switch | n:new-br | R:del-br | f:fetch | d:diff | r:delete | l:pull | m:commit | M:amend | p:push | t:tag | s:status | q:quit'

...
contains
    ...
    subroutine draw_interactive_tree(tree_root, items, n_items, selected, &
        ...
        print '(A)', 'Keys: j/k/↑/↓:nav | ←/→:collapse/expand | a:stage | u:unstage | S:stage-all | U:unstage-all | b:branch | f:fetch | d:diff | r:delete | l:pull | m:commit | p:push | t:tag | s:status | q:quit'
